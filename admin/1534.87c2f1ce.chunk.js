...
`,x=O=>{var M=O,{title:C,description:B,as:j,togglePosition:K,action:$}=M,W=o(M,["title","description","as","togglePosition","action"]);const U=(0,t.useRef)(null),{onToggle:S,toggle:w,expanded:R,id:L,size:A,variant:G,disabled:I}=(0,E.A)(),J=`accordion-content-${L}`,Z=`accordion-label-${L}`,X=`accordion-desc-${L}`,F=A==="M"?6:4,z=A==="M"?F:F-2,Y=D({expanded:R,disabled:I,variant:G}),Q={as:j,fontWeight:A==="S"?"bold":void 0,id:Z,textColor:R?"primary600":"neutral700",ellipsis:!0,variant:A==="M"?"delta":void 0},k=R?"primary600":"neutral600",q=R?"primary200":"neutral200",N=A==="M"?`${32/16}rem`:`${24/16}rem`,ee=()=>{I||(w&&!S?(n.warn('Deprecation warning: Usage of "toggle" prop in Accordion component is deprecated. This is discouraged and will be removed in the next major release. Please use "onToggle" instead'),w()):S())},H=t.createElement(d.k,{justifyContent:"center",borderRadius:"50%",height:N,width:N,transform:R?"rotate(180deg)":void 0,"data-strapi-dropdown":!0,disabled:I,"aria-hidden":!0,as:"span",background:q,cursor:I?"not-allowed":"pointer",onClick:()=>{var V;return(V=U==null?void 0:U.current)==null?void 0:V.click()},shrink:0},t.createElement(g.J,{as:u.default,width:A==="M"?`${11/16}rem`:`${8/16}rem`,color:R?"primary600":"neutral600"}));return t.createElement(f,{paddingBottom:z,paddingLeft:F,paddingRight:F,paddingTop:z,background:Y,expanded:R,size:A,justifyContent:"space-between",cursor:I?"not-allowed":""},t.createElement(s.K,{horizontal:!0,spacing:3,flex:1,maxWidth:"100%"},K==="left"&&H,t.createElement(v,_({ref:U,onClick:ee,"aria-disabled":I,"aria-expanded":R,"aria-controls":J,"aria-labelledby":Z,"data-strapi-accordion-toggle":!0,expanded:R,type:"button",flex:1,minWidth:0},W),t.createElement(t.Fragment,null,t.createElement(h.y,_({},Q),C),B&&t.createElement(c.Z,{as:"p",id:X,textColor:k},B))),K==="right"&&t.createElement(s.K,{horizontal:!0,spacing:3},H,$),K==="left"&&$))};x.defaultProps={action:void 0,as:"span",description:void 0,variant:"primary",togglePosition:"right"},x.propTypes={action:a.node,as:a.string,description:a.string,title:a.string.isRequired,togglePosition:a.oneOf(["right","left"]),variant:a.oneOf(["primary","secondary"])}},2407:(T,P,e)=>{"use strict";e.d(P,{$:()=>p,O:()=>_});var t=e(67294),a=e(45697),u=e(27821),m=e(16405),b=e(72735),c=e(35961),h=e(46273),E=e(63237),d=Object.defineProperty,s=Object.getOwnPropertySymbols,g=Object.prototype.hasOwnProperty,D=Object.prototype.propertyIsEnumerable,n=(o,v,f)=>v in o?d(o,v,{enumerable:!0,configurable:!0,writable:!0,value:f}):o[v]=f,i=(o,v)=>{for(var f in v||(v={}))g.call(v,f)&&n(o,f,v[f]);if(s)for(var f of s(v))D.call(v,f)&&n(o,f,v[f]);return o},r=(o,v)=>{var f={};for(var x in o)g.call(o,x)&&v.indexOf(x)<0&&(f[x]=o[x]);if(o!=null&&s)for(var x of s(o))v.indexOf(x)<0&&D.call(o,x)&&(f[x]=o[x]);return f};const l=(0,u.default)(h.k)`
  svg {
    height: ${10/16}rem;
    width: ${10/16}rem;
    path {
...
`,_=t.forwardRef((o,v)=>{var f=o,{children:x,icon:O,withBullet:M,as:C,isSubSectionChild:B}=f,j=r(f,["children","icon","withBullet","as","isSubSectionChild"]);return t.createElement(l,i({as:C,icon:O,background:"neutral100",paddingLeft:B?9:7,paddingBottom:2,paddingTop:2,ref:v},j),t.createElement(h.k,null,O?t.createElement(y,null,O):t.createElement(p,null),t.createElement(b.x,{paddingLeft:2},t.createElement(c.Z,{as:"span"},x))),M&&t.createElement(b.x,{as:h.k,paddingRight:4},t.createElement(p,{$active:!0})))});_.displayName="SubNavLink",_.defaultProps={as:E.f,icon:null,isSubSectionChild:!1,withBullet:!1},_.propTypes={as:a.elementType,children:a.node,icon:a.element,isSubSectionChild:a.bool,link:a.element,withBullet:a.bool}},29489:(T,P,e)=>{"use strict";e.d(P,{D:()=>r});var t=e(67294),a=e(45697),u=e(27821),m=e(35961),b=e(30190),c=e(7681),h=e(12645),E=e(72735),d=e(46273);const s=(0,u.default)(d.k)`
  border: none;
  padding: 0;
